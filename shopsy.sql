...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2023 at 11:01 AM
...
(10, 'golu jha', '6207002686', 'golu@g.c', 'araria', '202cb962ac59075b964b07152d234b70');
...
(31, 18, 'Kids', 'Toys', 6, 1),
(32, 9, 'Men', 'Shirts', 6, 5),
(35, 13, 'Women', 'Sarees', 10, 1),
(36, 13, 'Women', 'Sarees', 10, 1);
...
(1, 'GOLU', 'golu@gmail.com', '123'),
(2, 'GOLU JHA', 'golujha@gmail.com', '321');
...
(8, 'Men Slim Collar Casual Shirt', 1, 8, '455', 4, 'Nice colour & comfortable to wear...Short chinese collor shirt', 'shirt2.jpeg', 'Dennis Lingo ', 1),
...
--
ALTER TABLE `addcart`
  MODIFY `addcart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
